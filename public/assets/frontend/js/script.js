...
var HELPERS = {
    message: {
        ...
        success: function(message, fadeTime) {
            this.messageBar.removeClass('alert-danger').addClass('alert-success');
            this.display(message, fadeTime);
        },
        error: function(message, fadeTime) {
            this.messageBar.removeClass('alert-success').addClass('alert-danger');
            this.display(message, fadeTime);
        },
        display: function(message, fadeTime) {
    ...
    registerAutoCompleteSlug: function() {
        var slug = $('#slugToBeComplete'),
            text = slug.data('text-uname'),
            url  = slug.data('url');

        $('.register-user-autocomplete-slug').on('keyup', function(){
            var slugTxt = url + '/' + '<strong>' + $(this).val() + '</strong>';

            if ($(this).val() === '') {
                slug.html(url + '/' + '<strong>' + text + '</strong>');
            } else {
                slug.html(slugTxt);
            }
