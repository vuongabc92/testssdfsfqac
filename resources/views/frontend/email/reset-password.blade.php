...
<body style="width:100%;padding:0;margin:0;background-color:#eee;font-family:'Roboto Mono',monospace;font-size:16px;color:#333;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#eee">
        <tbody>
            <tr>
                <td>
                    <table style="width:100%;max-width:520px;margin:0 auto;" cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            <tr>
                                <td style="width:100%;padding:20px;">
                                    <table style="width:100%;float:left;" cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="padding:20px 20px 10px;">
                                                                    <p>{{ trans('mail.reset-password.hi') }} {{ $user->userProfile->first_name ?? trans('mail.reset-password.there') }},</p>
                                                                    <p>{{ trans('mail.reset-password.receive-request') }}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding-left:20px;padding-right:20px;" align="center">
                                                                    <a href="{{ $resetUrl }}" target="_blank" style="float:left;padding:10px 15px;background-color:#70be44;color:#fff;border-radius:3px;-webkit-border-radius:3px;text-decoration:none;">{{ trans('mail.reset-password.resetBtn') }}</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="padding:10px 20px 20px;font-size:13px;">
                                                                    ...
                                                                    <div style="width:100%;float:left;margin-top:10px;background-color:#f5f5f5;border-radius:3px;-webkit-border-radius:3px;color:#007aff;">
                                                                        <span style="float:left;padding:10px;color:#007aff;word-break:break-all;">{{ $resetUrl }}</span>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <p style="color:#666;text-align:center;">{{ trans('mail.support-team') }} | <a href="mailto:support@octocv.co" style="color:#5f94ce;text-decoration:none;">{{ config('frontend.email.support') }}</a><p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
