...
@section('body')
    ...
    <div class="_fwfl _mt20">
        {!! Form::open(['route' => 'back_page_save', 'method' => 'post', 'files' => true]) !!}
            ...
            @if($page->banner)
            <div class="form-group">
                <img src="/{{ $page->getBannerImage() }}" alt="{{ $page->title}}" class="img-thumbnail">
                <hr>
            </div>
            @endif
            <div class="form-group">
            ...
            <div class="form-group">
                {!! Form::text('page_slogan', $page->page_slogan, ['class' => 'form-control', 'placeholder' => 'Page slogan']) !!}
            </div>
            <div class="form-group">
                {!! Form::text('slug', $page->slug, ['class' => 'form-control', 'placeholder' => 'Page slug']) !!}
            </div>
            <div class="form-group">
